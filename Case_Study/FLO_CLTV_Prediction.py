...
# tanımlayınız. Not: cltv hesaplanırken frequency değerleri integer olması gerekmektedir.Bu nedenle alt ve üst
# limitlerini round() ile yuvarlayınız.
...
# dataframe'i oluşturunuz. Monetary değeri satın alma başına ortalama değer olarak, recency ve tenure değerleri ise
...
cltv_df["frequancy"] = df["order_num_total"]
...
bgf.fit(cltv_df["frequancy"],
        cltv_df["recency_cltv_weekly"],
        cltv_df["T_weekly"])

# a. 3 ay içerisinde müşterilerden beklenen satın almaları tahmin ediniz ve exp_sales_3_month olarak cltv
...
# b. 6 ay içerisinde müşterilerden beklenen satın almaları tahmin ediniz ve exp_sales_6_month olarak cltv
# dataframe'ine ekleyiniz.
cltv_df["exp_sales_3_month"] = bgf.predict(4*6,
                                          cltv_df["frequancy"],
                                          cltv_df["recency_cltv_weekly"],
                                          cltv_df["T_weekly"])
...
ggf.fit(cltv_df["frequancy"], cltv_df["monetary_cltv_avg"])
cltv_df["exp_average_value"] = ggf.conditional_expected_average_profit(cltv_df["frequancy"],
...
# 1. 6 aylık tüm müşterilerinizi 4 gruba (segmente) ayırınız ve grup isimlerini veri setine ekleyiniz. cltv_segment
# ismi ile dataframe'e ekleyiniz.
